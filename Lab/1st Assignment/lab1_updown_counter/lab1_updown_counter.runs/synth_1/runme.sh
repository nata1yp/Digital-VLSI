...
HD_PWD='C:/Users/User/lab1_updown_counter/lab1_updown_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter3_limit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter3_limit.tcl
