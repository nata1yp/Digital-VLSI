...
HD_PWD='C:/Users/User/lab1_updown_counter/lab1_updown_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter3_limit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter3_limit.tcl -notrace
