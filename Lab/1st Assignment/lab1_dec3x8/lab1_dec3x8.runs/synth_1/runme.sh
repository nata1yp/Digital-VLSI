...
HD_PWD='C:/Users/User/lab1_dec3x8/lab1_dec3x8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dec3x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dec3x8.tcl
